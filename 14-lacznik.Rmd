...
Mimo otrzymalnia tego samego wyniku, czas wykonania funkcji napisanej w C++ był około `r round(as.numeric(wynik["median"][[1]][1] / wynik["median"][[1]][2]), 2)` raza mniejszy.
