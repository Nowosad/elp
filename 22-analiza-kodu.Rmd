...
Funkcja `mi_do_km1` jest w stanie wykonać tylko `r round(round(unclass(wynik_2[[1, 6]]), 2)` operacji na sekundę, przy aż `r round(round(unclass(wynik_2[[2, 6]]), 2)` operacji na sekundę funkcji `mi_do_km2`.
