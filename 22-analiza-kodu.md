...
#> 1 mi_do_km1… 1.49µs 2.18µs 1.83µs  40.8µs   458893.     117KB     0 10000
#> 2 mi_do_km2… 1.08µs 1.44µs 1.25µs 240.8µs   693080.     222KB     0 10000
...
#> 1 mi_do_km1… 517ms 516.83ms  517ms 516.83ms      1.93     382MB     8     1
#> 2 mi_do_km2… 955µs   1.18ms  998µs   9.86ms    847.      78.2KB     8   424
#> # … with 1 more variable: total_time <bch:tm>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 1.93 operacji na sekundę, przy aż 846.55 operacji na sekundę funkcji `mi_do_km2`.
...
#> 1 mi_do_km1…    10   3.92µs   5.78µs   4.99µs 192.48µs 173008.          0B
#> 2 mi_do_km2…    10   1.79µs   2.36µs   2.04µs  40.28µs 424419.          0B
#> 3 mi_do_km1…   100  69.43µs  88.77µs  82.39µs  287.3µs  11266.     43.16KB
#> 4 mi_do_km2…   100   9.21µs   11.4µs  10.59µs 134.29µs  87733.        856B
#> 5 mi_do_km1…  1000   4.63ms   4.99ms   4.92ms   6.83ms    200.      3.87MB
#> 6 mi_do_km2…  1000  86.72µs 102.05µs  97.99µs 481.06µs   9800.      7.87KB
#> 7 mi_do_km1… 10000 557.95ms 557.95ms 557.95ms 557.95ms      1.79  382.04MB
#> 8 mi_do_km2… 10000 956.77µs   1.86ms  988.8µs  176.4ms    539.     78.18KB
