...
Powyższa wartość, `r unclass(dzis)`, oznacza liczbę dni od 1970-01-01.^[https://en.wikipedia.org/wiki/Unix_time]
...
1) stworz wektor
2) dodaj do wektora nazwy
3) sprawdź atrubuty
4) dodaj nowe elementy do wektora (seq)
5) przeskaluj wartosci
6) wydziel tylko wartosc nieNA
7) dla zamien wartosci wieksze niz X na Y
8) dodaj tekst to obiektu; wylicz srednia; jaki jest problem, jak go rozwiazac?
9) factory (nazwy stacji) - dodaj
10) dodaj daty + czas
