...
Dwa z nich, debugowanie używając funkcji takich jak print (sekcja \@ref(debuging-print)) i debugowanie interaktywne (sekcja \@ref(debuging-interactive)), są opisane w tym rozdziale.
