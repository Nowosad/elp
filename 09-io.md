...
Wielkość pliku tekstowego rośnie bardzo szybko wraz z liczbą elementów, a dodatkowo plik tekstowy nie przechowuje dodatkowych informacji specyficznych dla języków programowania.
...
Alternatywnie, jeżeli chcemy używać tych danych tylko w języku R możemy zapisać je do pliku w formacie RDS. 
...
Zawiera on ramkę danych z dwoma kolumnami opisującymi gejzer Old Faithful: `eruptions` - czas erupcji oraz `waiting` - czas oczekiwania na kolejną erupcję.
...
<p class="caption">(\#fig:marghamil)Obraz Alberta Bierstadta przedstawiający gejzer Old Faithful około roku 1881. Źródło: [Wikipedia](https://commons.wikimedia.org/wiki/File:Bierstadt_Albert_Old_Faithful.jpg).</p>
</div>
