...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.54us 1.71us   448434.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.14us 1.25us   752024.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 463ms  471ms      2.12     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 777us  801us   1061.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 17 operacji na sekundę, przy aż 19.97 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.91us   4.44us 210995.  
#> 2 mi_do_km2(l)    10   1.76us   1.96us 477406.  
#> 3 mi_do_km1(l)   100  66.26us  70.82us  13414.  
#> 4 mi_do_km2(l)   100   8.45us   9.47us  98552.  
#> 5 mi_do_km1(l)  1000   4.27ms   4.52ms    220.  
#> 6 mi_do_km2(l)  1000  76.53us  80.59us  11746.  
#> 7 mi_do_km1(l) 10000 522.56ms 522.56ms      1.91
#> 8 mi_do_km2(l) 10000 776.76us 811.99us   1103.  
