...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.58us 1.75us   492850.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.18us 1.29us   725995.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 452ms  460ms      2.17     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 784us  809us   1049.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 17.4 operacji na sekundę, przy aż 19.98 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.97us   4.48us 208980.  
#> 2 mi_do_km2(l)    10   1.84us   2.04us 462787.  
#> 3 mi_do_km1(l)   100     66us  70.35us  13618.  
#> 4 mi_do_km2(l)   100    8.5us   9.56us  97655.  
#> 5 mi_do_km1(l)  1000   4.22ms   4.48ms    221.  
#> 6 mi_do_km2(l)  1000   76.4us  80.42us  11950.  
#> 7 mi_do_km1(l) 10000    528ms    528ms      1.89
#> 8 mi_do_km2(l) 10000 787.44us 819.28us   1098.  
