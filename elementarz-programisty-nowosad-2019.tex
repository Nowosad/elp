...
Wynik, 18317, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.3us 1.43us   584864.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 988.9ns 1.14us   708589.     221KB}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 402ms  402ms      2.48     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 740us  785us   1122.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 21.12 operacji na sekundę, przy aż 24 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.23us   3.85us 210162.  
#> 2 mi_do_km2(l)    10   1.56us   1.75us 521232.  
#> 3 mi_do_km1(l)   100  55.52us  60.76us  15495.  
#> 4 mi_do_km2(l)   100   7.49us   8.66us 109393.  
#> 5 mi_do_km1(l)  1000   3.72ms   3.91ms    255.  
#> 6 mi_do_km2(l)  1000  67.39us  75.95us  12454.  
#> 7 mi_do_km1(l) 10000 408.21ms 409.01ms      2.44
#> 8 mi_do_km2(l) 10000 735.26us 783.25us   1119.  
