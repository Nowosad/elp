...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.62us 1.84us   462767.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.24us 1.35us   683376.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 476ms  488ms      2.05     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 801us  844us    964.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 16.39 operacji na sekundę, przy aż 19.76 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.97us   4.55us 201287.  
#> 2 mi_do_km2(l)    10   1.91us   2.11us 441027.  
#> 3 mi_do_km1(l)   100  66.22us  72.64us  12938.  
#> 4 mi_do_km2(l)   100   8.73us   9.49us  97452.  
#> 5 mi_do_km1(l)  1000   4.25ms   4.58ms    218.  
#> 6 mi_do_km2(l)  1000  77.74us  82.22us  11379.  
#> 7 mi_do_km1(l) 10000 735.64ms 735.64ms      1.36
#> 8 mi_do_km2(l) 10000 865.67us 914.84us    976.  
