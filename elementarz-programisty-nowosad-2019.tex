...
Wynik, 18050, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.59us 1.79us   476352.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.17us 1.31us   713452.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 473ms  481ms      2.08     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 782us  811us   1033.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 16.65 operacji na sekundę, przy aż 19.98 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.95us    4.5us 204733.  
#> 2 mi_do_km2(l)    10   1.78us   2.05us 453042.  
#> 3 mi_do_km1(l)   100  64.24us   71.1us  13457.  
#> 4 mi_do_km2(l)   100   8.32us   9.67us  95677.  
#> 5 mi_do_km1(l)  1000   4.33ms   4.55ms    218.  
#> 6 mi_do_km2(l)  1000  76.19us  81.46us  11742.  
#> 7 mi_do_km1(l) 10000 531.23ms 531.23ms      1.88
#> 8 mi_do_km2(l) 10000 784.12us 826.11us   1073.  
