...
Wynik, 18051, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.52us 1.74us   480790.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.15us 1.31us   688218.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 501ms  501ms      2.00     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 780us  821us   1010.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 15.96 operacji na sekundę, przy aż 19.99 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10    3.9us    4.5us 201649.  
#> 2 mi_do_km2(l)    10   1.78us   2.03us 456141.  
#> 3 mi_do_km1(l)   100  66.55us  74.57us  12499.  
#> 4 mi_do_km2(l)   100   8.46us   9.23us 101710.  
#> 5 mi_do_km1(l)  1000   4.21ms   4.41ms    225.  
#> 6 mi_do_km2(l)  1000  77.17us  83.11us  11487.  
#> 7 mi_do_km1(l) 10000 525.32ms 525.32ms      1.90
#> 8 mi_do_km2(l) 10000 797.09us 841.23us    782.  
