...
\CommentTok{#> 1 mi_do_km1(odl_mile)  1.6us 1.83us   448283.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.19us 1.33us   666610.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 500ms  500ms      2.00     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 783us  828us   1013.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 15.99 operacji na sekundę, przy aż 19.99 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10      4us   4.63us 187795.  
#> 2 mi_do_km2(l)    10   1.83us   2.04us 442574.  
#> 3 mi_do_km1(l)   100  66.12us  72.71us  12522.  
#> 4 mi_do_km2(l)   100   8.49us   9.22us 101216.  
#> 5 mi_do_km1(l)  1000   4.33ms    4.5ms    218.  
#> 6 mi_do_km2(l)  1000  76.97us  82.52us  11262.  
#> 7 mi_do_km1(l) 10000 612.58ms 612.58ms      1.63
#> 8 mi_do_km2(l) 10000 793.66us 822.87us   1085.  
