...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.23us 1.49us   575648.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.24us 1.46us   555578.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 389ms  397ms      2.52     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 738us  775us   1144.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 21.42 operacji na sekundę, przy aż 23.99 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.19us   3.65us 253174.  
#> 2 mi_do_km2(l)    10   1.47us   1.65us 566020.  
#> 3 mi_do_km1(l)   100  55.28us  59.85us  15836.  
#> 4 mi_do_km2(l)   100   7.43us   8.47us 112031.  
#> 5 mi_do_km1(l)  1000   3.73ms   3.81ms    258.  
#> 6 mi_do_km2(l)  1000  67.63us  75.55us  12592.  
#> 7 mi_do_km1(l) 10000 395.64ms 395.87ms      2.53
#> 8 mi_do_km2(l) 10000 877.56us 934.28us    962.  
