...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.51us 1.71us   496152.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.15us 1.29us   722687.     221KB}
...
\CommentTok{#> 2 mi_do_km2(odl_mile2) 780us  814us   1019.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 17.27 operacji na sekundę, przy aż 19.98 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.94us   4.53us 203621.  
#> 2 mi_do_km2(l)    10   1.79us   2.03us 463576.  
#> 3 mi_do_km1(l)   100  66.45us  71.34us  13246.  
#> 4 mi_do_km2(l)   100   8.53us   9.66us  96124.  
#> 5 mi_do_km1(l)  1000    4.3ms   4.59ms    217.  
#> 6 mi_do_km2(l)  1000  77.48us  81.51us  11672.  
#> 7 mi_do_km1(l) 10000 529.24ms 529.24ms      1.89
#> 8 mi_do_km2(l) 10000 790.82us 829.43us   1067.  
