...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.52us 1.72us   490801.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.15us 1.25us   736934.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 467ms  478ms      2.09     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 788us  816us   1032.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 16.74 operacji na sekundę, przy aż 19.99 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.91us   4.46us 199502.  
#> 2 mi_do_km2(l)    10   1.81us      2us 459299.  
#> 3 mi_do_km1(l)   100  66.26us  71.08us  12536.  
#> 4 mi_do_km2(l)   100   8.51us   9.43us  97894.  
#> 5 mi_do_km1(l)  1000   4.32ms   4.62ms    215.  
#> 6 mi_do_km2(l)  1000  76.62us  80.43us  11742.  
#> 7 mi_do_km1(l) 10000 538.24ms 538.24ms      1.86
#> 8 mi_do_km2(l) 10000 781.49us 810.48us   1096.  
