...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.52us 1.75us   486845.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.14us 1.26us   728368.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 479ms  488ms      2.05     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 786us  818us   1013.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 16.4 operacji na sekundę, przy aż 19.99 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.95us   4.66us 197282.  
#> 2 mi_do_km2(l)    10   1.78us   2.01us 470518.  
#> 3 mi_do_km1(l)   100  67.05us  73.58us  12843.  
#> 4 mi_do_km2(l)   100   8.47us   9.43us  99560.  
#> 5 mi_do_km1(l)  1000    4.3ms   4.73ms    209.  
#> 6 mi_do_km2(l)  1000  76.89us   83.1us  11497.  
#> 7 mi_do_km1(l) 10000 573.41ms 573.41ms      1.74
#> 8 mi_do_km2(l) 10000 891.05us 960.01us    908.  
