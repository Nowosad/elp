...
\hypertarget{tworzenie-skryptuxf3w}{%
\section{Tworzenie skryptów}\label{tworzenie-skryptuxf3w}}
...
Wynik, 18304, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.55us 1.74us   495017.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.24us 1.46us   553701.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 396ms  399ms      2.50     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 731us  791us   1107.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 21.28 operacji na sekundę, przy aż 23.97 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.21us   3.86us 239248.  
#> 2 mi_do_km2(l)    10   1.46us   1.69us 536752.  
#> 3 mi_do_km1(l)   100  55.85us  60.33us  15643.  
#> 4 mi_do_km2(l)   100   7.41us   8.47us 112303.  
#> 5 mi_do_km1(l)  1000   3.73ms   3.83ms    256.  
#> 6 mi_do_km2(l)  1000  67.62us  75.17us  12652.  
#> 7 mi_do_km1(l) 10000 401.21ms 401.94ms      2.49
#> 8 mi_do_km2(l) 10000 885.31us 936.09us    935.  
