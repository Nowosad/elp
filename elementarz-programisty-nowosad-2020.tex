...
Wynik, 19063, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.8us  1.9us   485933.    27.5KB}
\CommentTok{#> 2 mi_do_km2(odl_mile)   1.3us  1.4us   617640.    27.8KB}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2)    556ms 555.61ms      1.80}
\CommentTok{#> 2 mi_do_km2(odl_mile2)    988us   1.01ms    864.  }
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 1.8 operacji na sekundę, przy aż 864.07 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#>   expression                     min   median `itr/sec`}
\CommentTok{#>   <bch:expr>                <bch:tm> <bch:tm>     <dbl>}
\CommentTok{#> 1 mile_na_km(odl_mile2)        973us    992us      974.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2)    444us    479us     2079.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

Mimo otrzymania tego samego wyniku, czas wykonania funkcji napisanej w C++ był około 2.07 raza mniejszy.
