...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.27us  1.4us   615828.}
\CommentTok{#> 2 mi_do_km2(odl_mile) 905.01ns 1.02us   921207.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 387ms  387ms      2.59     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 743us  780us   1153.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.59 operacji na sekundę, przy aż 1152.86 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     738us  771us     1260.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 404us  433us     2296.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}
