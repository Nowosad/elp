...
\CommentTok{#> 1 mi_do_km1(odl_mile)  1.5us 1.73us   489283.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.17us 1.41us   634946.     224KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 572ms  572ms      1.75     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 829us  858us    990.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 1.75 operacji na sekundę, przy aż 990.31 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     824us  853us     1128.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 448us  475us     2050.}
