...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.3us 1.79us   498615.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 916.1ns 1.16us   671302.     221KB}
...
\CommentTok{#> 2 mi_do_km2(odl_mile2) 799us  847us   1045.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 21.13 operacji na sekundę, przy aż 21.97 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.26us   3.84us 239088.  
#> 2 mi_do_km2(l)    10   1.49us   1.81us 503630.  
#> 3 mi_do_km1(l)   100  56.11us   60.7us  15423.  
#> 4 mi_do_km2(l)   100   7.42us   8.61us 108955.  
#> 5 mi_do_km1(l)  1000   3.75ms   3.88ms    255.  
#> 6 mi_do_km2(l)  1000  67.82us  75.22us  12655.  
#> 7 mi_do_km1(l) 10000 430.08ms 432.71ms      2.31
#> 8 mi_do_km2(l) 10000 897.85us 968.68us    917.  
