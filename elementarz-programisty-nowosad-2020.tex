...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.41us 1.61us   523551.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.14us  1.3us   684317.     224KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 473ms  482ms      2.07     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 811us  840us   1042.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.07 operacji na sekundę, przy aż 1041.89 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
Wpisanie \texttt{x\ =\ 10} zamieni wartość obiektu \texttt{x} na \texttt{10},
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     802us  825us     1168.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 415us  442us     2164.}
