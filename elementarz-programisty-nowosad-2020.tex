...
Wynik, 19083, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#>   <bch:expr>          <bch:t> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile)   2.1us  2.5us   359928.    27.5KB}
\CommentTok{#> 2 mi_do_km2(odl_mile)   1.7us  1.9us   462339.    27.8KB}
...
\CommentTok{#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 645.45ms 645.45ms      1.55}
\CommentTok{#> 2 mi_do_km2(odl_mile2)   1.03ms   1.25ms    707.  }
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 1.55 operacji na sekundę, przy aż 707.01 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#>   expression                     min   median `itr/sec`}
\CommentTok{#>   <bch:expr>                <bch:tm> <bch:tm>     <dbl>}
\CommentTok{#> 1 mile_na_km(odl_mile2)       1.09ms   1.22ms      781.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2)  509.3us    557us     1716.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

Mimo otrzymania tego samego wyniku, czas wykonania funkcji napisanej w C++ był około 2.18 raza mniejszy.
