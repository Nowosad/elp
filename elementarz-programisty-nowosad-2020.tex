...
Wynik, 18332, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.25us 1.42us   582654.}
\CommentTok{#> 2 mi_do_km2(odl_mile) 927.01ns  1.1us   722713.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 410ms  416ms      2.41     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 754us  801us   1107.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 20.44 operacji na sekundę, przy aż 21.97 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10   3.22us   3.79us 242148.  
#> 2 mi_do_km2(l)    10   1.49us   1.71us 540775.  
#> 3 mi_do_km1(l)   100   55.6us  61.47us  15190.  
#> 4 mi_do_km2(l)   100   7.43us    8.8us 106397.  
#> 5 mi_do_km1(l)  1000   3.79ms   3.91ms    251.  
#> 6 mi_do_km2(l)  1000  68.16us  76.58us  12318.  
#> 7 mi_do_km1(l) 10000 417.72ms 417.76ms      2.39
#> 8 mi_do_km2(l) 10000 745.64us    804us   1082.  
