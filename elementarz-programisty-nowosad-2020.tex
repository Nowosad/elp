...
Wynik, 18318, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile) 1.57us 1.74us   493928.     117KB}
\CommentTok{#> 2 mi_do_km2(odl_mile) 1.23us 1.43us   563633.     221KB}
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km1(odl_mile2) 412ms  414ms      2.41     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 739us  794us   1105.      78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

W tym przypadku różnica pomiędzy \texttt{mi\_do\_km1} a \texttt{mi\_do\_km2} staje się dużo większa.
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 20.51 operacji na sekundę, przy aż 23.97 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
#> 1 mi_do_km1(l)    10    3.2us   3.72us 245853.  
#> 2 mi_do_km2(l)    10   1.45us   1.69us 529120.  
#> 3 mi_do_km1(l)   100  55.72us  61.57us  15142.  
#> 4 mi_do_km2(l)   100    7.4us   8.65us 109105.  
#> 5 mi_do_km1(l)  1000   3.81ms   3.99ms    246.  
#> 6 mi_do_km2(l)  1000  67.64us  77.91us  12002.  
#> 7 mi_do_km1(l) 10000 408.88ms 414.85ms      2.41
#> 8 mi_do_km2(l) 10000 733.38us 806.13us   1088.  
