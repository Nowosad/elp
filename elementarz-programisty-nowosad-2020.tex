...
\CommentTok{# funkcja}
\KeywordTok{pole_prostokata}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
Wynik, 19203, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> [1] "/home/runner/work/elp/elp"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meteo =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"pliki/dane_meteo.csv"}\NormalTok{, }\DataTypeTok{encoding =} \StringTok{"UTF-8"}\NormalTok{)}
\KeywordTok{str}\NormalTok{(meteo)}
\CommentTok{#> 'data.frame':    730 obs. of  7 variables:}
\CommentTok{#>  $ kod_stacji  : int  352160330 352160330 352160330 352160330 352160330 352160330 352160330 352160330 352160330 352160330 ...}
\CommentTok{#>  $ nazwa_stacji: chr  "POZNAŃ" "POZNAŃ" "POZNAŃ" "POZNAŃ" ...}
...
\CommentTok{#>   kod_stacji nazwa_st~1   rok miesiac dzien  tavg precip}
\CommentTok{#>        <dbl> <chr>      <dbl>   <dbl> <dbl> <dbl>  <dbl>}
\CommentTok{#> 1  352160330 POZNAŃ      2017       1     1   1.4    0  }
\CommentTok{#> 2  352160330 POZNAŃ      2017       1     2   0.1    0  }
\CommentTok{#> 3  352160330 POZNAŃ      2017       1     3   0.5    4.8}
\CommentTok{#> 4  352160330 POZNAŃ      2017       1     4   1.5    2.3}
\CommentTok{#> 5  352160330 POZNAŃ      2017       1     5  -3.5    0  }
\CommentTok{#> 6  352160330 POZNAŃ      2017       1     6  -8.4    0  }
\CommentTok{#> # ... with abbreviated variable name 1: nazwa_stacji}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression               min   median itr/se~1 mem_a~2}
\CommentTok{#>   <bch:expr>          <bch:tm> <bch:tm>    <dbl> <bch:b>}
\CommentTok{#> 1 mi_do_km1(odl_mile)    1.8us      2us  456780.  27.5KB}
\CommentTok{#> 2 mi_do_km2(odl_mile)    1.4us    1.5us  642224.  27.8KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>, and}
\CommentTok{#> #   abbreviated variable names 1: `itr/sec`,}
\CommentTok{#> #   2: mem_alloc}
\CommentTok{#> # i Use `colnames()` to see all variable names}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> # A tibble: 2 x 6}
\CommentTok{#>   expression                min   median itr/s~1 mem_a~2}
\CommentTok{#>   <bch:expr>           <bch:tm> <bch:tm>   <dbl> <bch:b>}
\CommentTok{#> 1 mi_do_km1(odl_mile2)    468ms    472ms    2.12   382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2)    921us    942us  932.    78.2KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>, and}
\CommentTok{#> #   abbreviated variable names 1: `itr/sec`,}
\CommentTok{#> #   2: mem_alloc}
\CommentTok{#> # i Use `colnames()` to see all variable names}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.12 operacji na sekundę, przy aż 931.86 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#> # A tibble: 2 x 6}
\CommentTok{#>   expression                  min median itr/s~1 mem_a~2}
\CommentTok{#>   <bch:expr>                <bch> <bch:>   <dbl> <bch:b>}
\CommentTok{#> 1 mile_na_km(odl_mile2)     916us  934us   1036. 291.2KB}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 450us  460us   2142.  84.8KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>, and}
\CommentTok{#> #   abbreviated variable names 1: `itr/sec`,}
\CommentTok{#> #   2: mem_alloc}
\CommentTok{#> # i Use `colnames()` to see all variable names}
...
Mimo otrzymania tego samego wyniku, czas wykonania funkcji napisanej w C++ był około 2.03 raza mniejszy.
...
\NormalTok{ ! [}\ExtensionTok{rejected}\NormalTok{]        main -}\OperatorTok{>}\NormalTok{ main (fetch first)}
...
\FunctionTok{Version:}\AttributeTok{ }\FloatTok{0.0.1}
...
\FunctionTok{LazyData:}\AttributeTok{ }\CharTok{true}
\FunctionTok{RoxygenNote:}\AttributeTok{ }\FloatTok{6.1.1}
\end{Highlighting}
\end{Shaded}
