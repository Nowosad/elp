...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.25us 1.39us   610049.}
\CommentTok{#> 2 mi_do_km2(odl_mile)  919.1ns 1.02us   924572.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 360ms  363ms      2.75     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 696us  743us   1224.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.75 operacji na sekundę, przy aż 1224.03 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     700us  741us     1252.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 377us  407us     2436.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}
