...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.25us  1.4us   608695.}
\CommentTok{#> 2 mi_do_km2(odl_mile) 950.07ns 1.06us   878422.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 403ms  404ms      2.48     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 749us  787us   1123.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.48 operacji na sekundę, przy aż 1122.89 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#>   expression             min median `itr/sec` mem_alloc}
\CommentTok{#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>}
\CommentTok{#> 1 mi_do_km2(odl_mile2) 786us  824us     1157.   599.2KB}
\CommentTok{#> 2 mi_do_km3(odl_mile2) 419us  465us     2129.    85.9KB}
\CommentTok{#> # ... with 1 more variable: `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

\hypertarget{cpp}{%
\subsection{.cpp}\label{cpp}}
