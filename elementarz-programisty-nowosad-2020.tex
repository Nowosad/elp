...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.26us 1.42us   592374.}
\CommentTok{#> 2 mi_do_km2(odl_mile) 925.04ns 1.03us   899365.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 378ms  384ms      2.60     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 741us  785us   1130.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.6 operacji na sekundę, przy aż 1129.89 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
W powyższej składni też widać sposób definiowania komentarzy w języku C++ używając operatora \texttt{//}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Rcpp}\OperatorTok{::}\KeywordTok{cppFunction}\NormalTok{(rcpp_fun2)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     741us  776us     1251.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 389us  437us     2265.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}
