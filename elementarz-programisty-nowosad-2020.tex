...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.31us 1.48us   577581.}
\CommentTok{#> 2 mi_do_km2(odl_mile) 944.01ns 1.05us   886075.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 394ms  399ms      2.51     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 762us  797us   1104.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.51 operacji na sekundę, przy aż 1104.34 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
Więcej informacji na ten temat można znaleść na stronie \url{http://www.rcpp.org/}, w \href{https://adv-r.hadley.nz/rcpp.html}{rozdziale Rewriting R code in C++} książki \citet{wickham2014advanced}, {[}sekcji Rcpp{]} książki \citet{gillespie2016efficient}, oraz na stronie \href{https://thecoatlessprofessor.com/programming/cpp/unofficial-rcpp-api-documentation}{Unofficial Rcpp API Documentation}.
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     744us  787us     1233.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 409us  437us     2266.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}
