...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.56us 1.75us   497070.}
\CommentTok{#> 2 mi_do_km2(odl_mile) 915.02ns 1.05us   879642.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 373ms  377ms      2.65     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 725us  769us   1157.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.65 operacji na sekundę, przy aż 1157.41 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     741us  770us     1258.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 392us  421us     2345.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}

Mimo otrzymalnia tego samego wyniku, czas wykonania funkcji napisanej w C++ był około 1.83 raza mniejszy.
