...
Wynik, 18366, oznacza liczbę dni od 1970-01-01.\footnote{\url{https://en.wikipedia.org/wiki/Unix_time}}
...
\CommentTok{#> 1 mi_do_km1(odl_mile)   1.28us  1.4us   618143.}
\CommentTok{#> 2 mi_do_km2(odl_mile) 966.01ns 1.06us   888782.}
...
\CommentTok{#> 1 mi_do_km1(odl_mile2) 385ms  390ms      2.56     382MB}
\CommentTok{#> 2 mi_do_km2(odl_mile2) 733us  765us   1191.      78.2KB}
...
Funkcja \texttt{mi\_do\_km1} jest w stanie wykonać tylko 2.56 operacji na sekundę, przy aż 1190.87 operacji na sekundę funkcji \texttt{mi\_do\_km2}.
...
\CommentTok{#> 1 mile_na_km(odl_mile2)     727us  760us     1276.}
\CommentTok{#> 2 mile_na_km_cpp(odl_mile2) 395us  426us     2321.}
\CommentTok{#> # ... with 2 more variables: mem_alloc <bch:byt>,}
\CommentTok{#> #   `gc/sec` <dbl>}
\end{Highlighting}
\end{Shaded}
