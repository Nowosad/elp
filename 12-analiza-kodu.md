...
#> 1 mi_do_km1(odl_mile)  1.5µs 1.65µs   527513.     117KB
#> 2 mi_do_km2(odl_mile) 1.23µs 1.47µs   603309.     224KB
...
#> 2 mi_do_km2(odl_mile2) 816µs  842µs   1038.      78.2KB
#> # … with 1 more variable: `gc/sec` <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 1.97 operacji na sekundę, przy aż 1037.89 operacji na sekundę funkcji `mi_do_km2`.
