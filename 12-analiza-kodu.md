...
#> 1 mi_do_km1(odl_mile)   1.5µs 1.58µs   570585.     117KB
#> 2 mi_do_km2(odl_mile)  1.16µs 1.26µs   747438.     224KB
...
#> 1 mi_do_km1(odl_mile2)  528ms  528ms      1.89     382MB
#> 2 mi_do_km2(odl_mile2)  808µs  831µs   1018.      78.2KB
#> # … with 1 more variable: gc/sec <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 1.89 operacji na sekundę, przy aż 1017.88 operacji na sekundę funkcji `mi_do_km2`.
