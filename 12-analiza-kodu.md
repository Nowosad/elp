...
#> 1 mi_do_km1(odl_mile)   1.26µs   1.42µs   590570.     117KB        0
#> 2 mi_do_km2(odl_mile) 918.98ns   1.12µs   697327.     221KB        0
```
...
#>   expression                min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 mi_do_km1(odl_mile2)    425ms    428ms      2.34     382MB     19.9
#> 2 mi_do_km2(odl_mile2)    751µs    800µs   1092.      78.2KB     24.0
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 19.88 operacji na sekundę, przy aż 24 operacji na sekundę funkcji `mi_do_km2`.
...
#> 1 mi_do_km1(l)    10   3.22µs   3.81µs 236716.          0B     47.4
#> 2 mi_do_km2(l)    10   1.48µs   1.71µs 522399.          0B     52.2
#> 3 mi_do_km1(l)   100  56.29µs  61.86µs  15133.     43.16KB     16.7
#> 4 mi_do_km2(l)   100   7.43µs   8.91µs 104637.        856B     31.4
#> 5 mi_do_km1(l)  1000   3.79ms   3.99ms    247.      3.87MB     22.0
#> 6 mi_do_km2(l)  1000  69.42µs  78.05µs  12037.      7.87KB     24.6
#> 7 mi_do_km1(l) 10000 411.84ms 412.03ms      2.43  382.04MB     21.8
#> 8 mi_do_km2(l) 10000 729.53µs 796.08µs   1095.     78.18KB     26.0
```
