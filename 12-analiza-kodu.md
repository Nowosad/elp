...
#> 1 mi_do_km1(odl_mile)   1.57µs   1.74µs   494274.     117KB        0
#> 2 mi_do_km2(odl_mile)   1.17µs    1.3µs   714723.     221KB        0
```
...
#>   expression                min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 mi_do_km1(odl_mile2)    454ms    456ms      2.19     382MB     17.5
#> 2 mi_do_km2(odl_mile2)    776µs    809µs   1054.      78.2KB     20.0
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 17.55 operacji na sekundę, przy aż 19.99 operacji na sekundę funkcji `mi_do_km2`.
...
#> 1 mi_do_km1(l)    10   3.91µs   4.45µs 205527.          0B     41.1
#> 2 mi_do_km2(l)    10   1.81µs   2.01µs 460421.          0B      0  
#> 3 mi_do_km1(l)   100  65.95µs  70.27µs  13541.     43.16KB     14.2
#> 4 mi_do_km2(l)   100   8.52µs   9.52µs  96992.        856B     29.1
#> 5 mi_do_km1(l)  1000   4.32ms   4.53ms    220.      3.87MB     19.5
#> 6 mi_do_km2(l)  1000  76.41µs  80.06µs  11819.      7.87KB     22.5
#> 7 mi_do_km1(l) 10000 537.25ms 537.25ms      1.86  382.04MB     14.9
#> 8 mi_do_km2(l) 10000 769.84µs 816.54µs   1097.     78.18KB     20.0
```
