...
#> 1 mi_do_km1(odl_mile)  1.44µs 1.62µs   517131.     117KB
#> 2 mi_do_km2(odl_mile)   1.1µs 1.25µs   748501.     224KB
...
#> 1 mi_do_km1(odl_mile2)  489ms  490ms      2.04     382MB
#> 2 mi_do_km2(odl_mile2)  804µs  831µs   1082.      78.2KB
#> # … with 1 more variable: gc/sec <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 2.04 operacji na sekundę, przy aż 1081.9 operacji na sekundę funkcji `mi_do_km2`.
