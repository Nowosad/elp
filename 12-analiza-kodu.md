...
#> 1 mi_do_km1(odl_mile)  1.48µs 1.64µs   515000.     117KB
#> 2 mi_do_km2(odl_mile)  1.18µs 1.31µs   721206.     224KB
...
#> 1 mi_do_km1(odl_mile2)  486ms  487ms      2.06     382MB
#> 2 mi_do_km2(odl_mile2)  793µs  821µs   1107.      78.2KB
#> # … with 1 more variable: gc/sec <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 2.06 operacji na sekundę, przy aż 1106.77 operacji na sekundę funkcji `mi_do_km2`.
