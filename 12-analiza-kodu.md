...
#> 1 mi_do_km1(odl_mile)   1.4µs 1.58µs   532081.     117KB
#> 2 mi_do_km2(odl_mile)  1.09µs 1.27µs   747202.     224KB
...
#> 1 mi_do_km1(odl_mile2)  485ms  486ms      2.06     382MB
#> 2 mi_do_km2(odl_mile2)  793µs  822µs   1101.      78.2KB
#> # … with 1 more variable: gc/sec <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 2.06 operacji na sekundę, przy aż 1101.37 operacji na sekundę funkcji `mi_do_km2`.
