...
#> 1 mi_do_km1(odl_mile)   1.54µs   1.79µs   478100.     117KB        0
#> 2 mi_do_km2(odl_mile)   1.15µs   1.27µs   714666.     221KB        0
```
...
#>   expression                min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 mi_do_km1(odl_mile2)    458ms    463ms      2.16     382MB     17.3
#> 2 mi_do_km2(odl_mile2)    805µs    836µs   1007.      78.2KB     18.0
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 17.29 operacji na sekundę, przy aż 17.99 operacji na sekundę funkcji `mi_do_km2`.
...
#> 1 mi_do_km1(l)    10   3.94µs   4.63µs 194655.          0B     38.9
#> 2 mi_do_km2(l)    10    1.8µs   2.05µs 451505.          0B     45.2
#> 3 mi_do_km1(l)   100  66.97µs  73.24µs  13057.     43.16KB     14.2
#> 4 mi_do_km2(l)   100   8.57µs   9.39µs  99300.        856B     29.8
#> 5 mi_do_km1(l)  1000   4.35ms   4.59ms    215.      3.87MB     20.0
#> 6 mi_do_km2(l)  1000  77.92µs  82.79µs  11509.      7.87KB     20.1
#> 7 mi_do_km1(l) 10000 570.18ms 570.18ms      1.75  382.04MB     14.0
#> 8 mi_do_km2(l) 10000 805.08µs 835.55µs   1063.     78.18KB     20.0
```
