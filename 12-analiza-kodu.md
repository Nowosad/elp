...
#> 1 mi_do_km1(odl_mile) 1.46µs 1.73µs   499756.     117KB
#> 2 mi_do_km2(odl_mile) 1.16µs 1.33µs   664027.     224KB
...
#>   expression             min median `itr/sec` mem_alloc
#>   <bch:expr>           <bch> <bch:>     <dbl> <bch:byt>
#> 1 mi_do_km1(odl_mile2) 474ms  484ms      2.07     382MB
#> 2 mi_do_km2(odl_mile2) 821µs  841µs   1019.      78.2KB
#> # … with 1 more variable: `gc/sec` <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 2.07 operacji na sekundę, przy aż 1018.68 operacji na sekundę funkcji `mi_do_km2`.
