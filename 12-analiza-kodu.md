...
#> 1 mi_do_km1(odl_mile)   1.53µs   1.76µs   481258.     117KB        0
#> 2 mi_do_km2(odl_mile)   1.19µs    1.3µs   700896.     221KB        0
```
...
#>   expression                min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 mi_do_km1(odl_mile2)    458ms    468ms      2.14     382MB     17.1
#> 2 mi_do_km2(odl_mile2)    750µs    811µs   1023.      78.2KB     20.0
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 17.08 operacji na sekundę, przy aż 19.99 operacji na sekundę funkcji `mi_do_km2`.
...
#> 1 mi_do_km1(l)    10   3.82µs   4.55µs 200442.          0B     20.0
#> 2 mi_do_km2(l)    10   1.78µs   2.02µs 458730.          0B     45.9
#> 3 mi_do_km1(l)   100  64.77µs   71.3µs  13264.     43.16KB     17.1
#> 4 mi_do_km2(l)   100   8.23µs   9.27µs 100203.        856B     20.0
#> 5 mi_do_km1(l)  1000   4.23ms   4.54ms    219.      3.87MB     19.7
#> 6 mi_do_km2(l)  1000  74.38µs   81.3µs  11654.      7.87KB     22.8
#> 7 mi_do_km1(l) 10000 556.19ms 556.19ms      1.80  382.04MB     14.4
#> 8 mi_do_km2(l) 10000 767.69µs 833.05µs   1068.     78.18KB     20.0
```
