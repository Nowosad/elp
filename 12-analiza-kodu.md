...
#> 1 mi_do_km1(odl_mile)   1.8µs    2µs   464997.    27.5KB
#> 2 mi_do_km2(odl_mile)   1.4µs  1.5µs   599078.    27.8KB
...
#> 2 mi_do_km2(odl_mile2)  979µs    1ms    883.      78.2KB
#> # … with 1 more variable: `gc/sec` <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 1.83 operacji na sekundę, przy aż 883.32 operacji na sekundę funkcji `mi_do_km2`.
