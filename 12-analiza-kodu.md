...
#> 1 mi_do_km1(odl_mile)  1.48µs 1.66µs   507742.     117KB
#> 2 mi_do_km2(odl_mile)  1.18µs 1.34µs   710867.     224KB
...
#> 1 mi_do_km1(odl_mile2)  493ms  494ms      2.02     382MB
#> 2 mi_do_km2(odl_mile2)  798µs  830µs   1078.      78.2KB
#> # … with 1 more variable: gc/sec <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 2.02 operacji na sekundę, przy aż 1077.78 operacji na sekundę funkcji `mi_do_km2`.
