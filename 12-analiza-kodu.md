...
#> 1 mi_do_km1(odl_mile)  1.51µs  1.6µs   564083.     117KB
#> 2 mi_do_km2(odl_mile)  1.16µs 1.25µs   743869.     224KB
...
#> 1 mi_do_km1(odl_mile2)  531ms  531ms      1.88     382MB
#> 2 mi_do_km2(odl_mile2)  806µs  826µs   1019.      78.2KB
#> # … with 1 more variable: gc/sec <dbl>
```

W tym przypadku różnica pomiędzy `mi_do_km1` a `mi_do_km2` staje się dużo większa. 
Funkcja `mi_do_km1` jest w stanie wykonać tylko 1.88 operacji na sekundę, przy aż 1018.7 operacji na sekundę funkcji `mi_do_km2`.
